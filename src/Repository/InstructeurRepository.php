 ...
 */
class InstructeurRepository extends ServiceEntityRepository implements PasswordUpgraderInterface
{
     ...
     */
    public function add(Instructeur $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Instructeur $entity, bool $flush = true): void
    {
    ...
    {
        if (!$user instanceof Instructeur) {
